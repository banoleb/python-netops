...
class MyNetmiko(CiscoIosSSH):
    ...
    def send_command(self, command,st_command=True):
        with ConnectHandler(**device_params) as net_connect:
            net_connect.enable()
            result = net_connect.send_command(command, strip_command=st_command)
...
print(r1.send_command('sh ip int br', st_command=False))
